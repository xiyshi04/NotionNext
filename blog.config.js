...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '20e3546d376780de9204dbe54e97217d,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'xiyshi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个正在学习的开发者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiyshi.top', // 网站地址
